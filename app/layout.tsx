  ...
  return (
    <html lang="en" className="h-full antialiased">
      <body className="h-full" suppressHydrationWarning>
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] rounded-full bg-cyan-500 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-black/40"
        >
          Skip to content
        </a>
